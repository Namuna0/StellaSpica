...
partial class Program
{
    private async Task Gather(SocketMessage message, SocketGuild guild, SocketGuildUser user)
    {
        ...
        await Command2(texts, 113, message, user, async () =>
        {
            ...
            {
                area = "🌳白亜の森（Lv2から利用可能）\r\n【採取《1d100》1-50：雑草/51-60：薬草/61-70：ヒラタケ/71-85：木立のトウガラシ/86-90：青癒草/91-95:ハチミツ/96-100：カカオ】\r\n";
    ...
    private async Task Fell(SocketMessage message, SocketGuild guild, SocketGuildUser user)
    {
        ...
        await Command2(texts, 113, message, user, async () =>
        {
            ...
            {
                area = "🏕️エイル湖湖畔（Lv1から利用可能）\r\n【伐採《1d100》1-50：何もなし/51-95：白樺材/96-100：ルチェの実（果物）】\r\n";
            ...
            {
                area = "🏕️森林地帯（Lv4から利用可能）\r\n【伐採《1d100》1-40：何もなし/41-59：木材×1d3個/60-78：ミカン/79-89：クルミ材/90-100：上質なクルミ材】\r\n";
